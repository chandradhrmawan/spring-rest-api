...
public class SupplierControler {
  ...
  public ResponseEntity<ResponseData<Supplier>> create(
    ...
    responseData.setPayload(supplierService.saveOrUpdatSupplier(supplier));
  ...
  public List<Supplier> findSupplierByNameContains(@RequestBody SearchData searchData) {
    return supplierService.findSupplierByName(searchData.getSearchKey());
  }

  @PostMapping("/search/name/start")
  public List<Supplier> findByNameStarting(@RequestBody SearchData searchData) {
    return supplierService.findByNameStarting(searchData.getSearchKey());
  }

  @PostMapping("/search/name/email")
  public List<Supplier> findByNameContainsOrEmailContains(@RequestBody SearchData searchData) {
    return supplierService.findByNameOrEmail(
        searchData.getSearchKey(),
        searchData.getOtherSearchKey());
  }
